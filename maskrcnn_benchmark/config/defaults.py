...
_C.MODEL.PRETRAINED_DETECTOR_CKPT_OI = datasets_path+\
                                    "datasets/oi_v6/detector_model/model_final.pth"
...
_C.DATASETS.OI_V6_TRAIN = ()
_C.DATASETS.OI_V6_VAL = ()
_C.DATASETS.OI_V6_TEST = ()
...
_C.MODEL.ROI_BOX_HEAD.OI_V6_NUM_CLASSES = 602  # 601 object classes + background; update after preprocessing
...
_C.MODEL.ROI_RELATION_HEAD.OI_V6_NUM_CLASSES = 31  # 30 relationship classes + background
...
_C.MODEL.ROI_RELATION_HEAD.AUM = CN()
_C.MODEL.ROI_RELATION_HEAD.AUM.TAU1   = 10000   # iteration when γ starts rising  (stage 1 → 2 boundary)
_C.MODEL.ROI_RELATION_HEAD.AUM.TAU2   = 20000   # iteration when γ reaches λ      (stage 2 → 3 boundary)
_C.MODEL.ROI_RELATION_HEAD.AUM.LAMBDA = 0.8     # maximum uncertainty weight
