...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "OI_V6": {
            "img_dir": datasets_path + "datasets/oi_v6/images",
            "dict_file": datasets_path + "datasets/oi_v6/OI_V6_dict.json",
            "train_file": datasets_path + "datasets/oi_v6/OI_V6_Train.json",
            "test_file": datasets_path + "datasets/oi_v6/OI_V6_Test.json",
        },
    }
